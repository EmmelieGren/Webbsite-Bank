...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:###@localhost/bank'
#app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://###@mlibank.mysql.database.azure.com/mlibank'
